    ...
    <Card className="col-span-1 md:col-span-2" style={{ padding: 18 }}>
      ...
      <ResponsiveContainer width="100%" height={220}>
        <AreaChart data={stats.curve}>
          ...
          <XAxis dataKey="label" tick={{ fill: C.text, fontSize: 10, fontFamily: FONT.mono }} axisLine={{ stroke: C.borderLite }} tickLine={false} interval="preserveStartEnd" />
          <YAxis tick={{ fill: C.text, fontSize: 10, fontFamily: FONT.mono }} axisLine={false} tickLine={false} width={55} tickFormatter={(v) => `$${v}`} />
